...
public class newMain {
    static public void main(String[] argv){
         Book b1=new Book(); b1.book_name="Война и мир";
         Book b2=new Book(); b2.book_name="Преступление и наказание";
         Book b3=new Book(); b3.book_name="Идиот";

         Reader r1 = new Reader(); r1.firstname="Иван";r1.lastname="Иванов";
         Reader r2 = new Reader(); r2.firstname="Петр";r2.lastname="Петров";
        ...
        for (int i=0;i<=Table1.size();i++){
            for (int j=0; ; j++){
                if (Table1.get(j)[0].equals(Table1.get(i)[0])){
